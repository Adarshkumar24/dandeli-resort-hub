              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <div className="flex flex-col">
                    <a href="https://wa.me/918260230183?text=Hi!%20I'm%20interested%20in%20booking%20an%20adventure%20at%20Dandeli." target="_blank" rel="noopener noreferrer" className="text-accent-foreground/80 hover:text-accent-foreground transition-colors duration-300">
                      +91 8260230183
                    </a>
                  </div>
                </li>
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-accent-foreground/80 text-base">pradhanadarsh727@gmail.com</span>
                </li>
              </ul>
            </div>
