...
export const sendEmail = async (data: EmailData): Promise<boolean> => {
  try {
    ...
    // In a real implementation, you would send to pradhanadarsh727@gmail.com
    ...
    const response = await fetch('https://api.sendgrid.com/v3/mail/send', {
      ...
      body: JSON.stringify({
        ...
        from: { email: 'pradhanadarsh727@gmail.com', name: 'Dandeli Adventures' },
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>📞 +91 8260230183<br>📧 pradhanadarsh727@gmail.com</p>
...
export const formatBookingSMS = (bookingData: any): string => {
  return `Thank you for booking with Dandeli Adventures! Your booking for ${bookingData.date ? bookingData.date.toLocaleDateString() : 'your selected date'} is confirmed (Ref: ${bookingData.paymentTransactionId || 'Processing'}). For assistance, call +91 8260230183.`;
};
