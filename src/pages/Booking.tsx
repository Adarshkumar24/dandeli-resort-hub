            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 animate-fade-in animation-delay-400">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p className="text-accent">+91 8260230183</p>
                  <p className="font-medium mt-3">Email:</p>
                  <p className="text-accent">pradhanadarsh727@gmail.com</p>
                </div>
              </div>
              ...
              <div className="bg-accent/10 rounded-lg p-6 animate-fade-in animation-delay-600">
                ...
                <p className="font-medium text-sm">- Adarsh Pradhan</p>
              </div>
            </div>
          </div>
        </div>
...
const faqs = [{
  ...
  answer: "You can make a reservation by filling out the booking form on our website, calling our reservation team, or sending an email to pradhanadarsh727@gmail.com."
}, {
